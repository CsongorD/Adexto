          ...
          <div className="card space-y-6 p-4 sm:space-y-8 sm:p-6 lg:p-8">
            <div className="grid gap-6 sm:gap-8 md:grid-cols-2">
              <div className="space-y-4">
                <h3 className="mb-3 text-lg font-semibold text-primary-900 sm:mb-4 sm:text-xl">
                  Cene ugradnje:
                </h3>
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex flex-col space-y-1 rounded-lg bg-primary-100 p-2 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 sm:p-3">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-xs text-primary-600 sm:space-y-3 sm:text-sm">
